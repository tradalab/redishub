...
import { Heading } from "@/components/x/heading"
...
const Overlay = React.forwardRef<React.ElementRef<typeof RadixAlertDialog.Overlay>, React.ComponentPropsWithoutRef<typeof RadixAlertDialog.Overlay>>(
  ({ className, ...props }, ref) => {
    return (
...
const Title = React.forwardRef<React.ElementRef<typeof RadixAlertDialog.Title>, Omit<React.ComponentPropsWithoutRef<typeof RadixAlertDialog.Title>, "asChild">>(
  ({ className, children, ...props }, ref) => {
    return (
      <RadixAlertDialog.Title ref={ref} className={cn(className)} {...props} asChild>
...
const Content = React.forwardRef<React.ElementRef<typeof RadixAlertDialog.Content>, React.ComponentPropsWithoutRef<typeof RadixAlertDialog.Content>>(
  ({ className, ...props }, ref) => {
    return (
      <Portal>
        <Overlay />
...
>(({ className, ...props }, ref) => {
  return <RadixAlertDialog.Description ref={ref} className={cn("text-ui-fg-subtle txt-compact-medium", className)} {...props} />
})
...
>(({ className, children, type, ...props }, ref) => {
  ...
  return (
    <RadixAlertDialog.Action ref={ref} className={className} {...props} asChild>
      <Button size="sm" type={type} variant={variant === "danger" ? "destructive" : "default"}>
        {children}
      </Button>
...
>(({ className, children, ...props }, ref) => {
  return (
    <RadixAlertDialog.Cancel ref={ref} className={cn(className)} {...props} asChild>
